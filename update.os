...
Процедура ОсновнаяОбработка()
	...
	Если ЗначениеЗаполнено(Фильтр) Тогда
		...
		Иначе
			Сообщить("Фильтр не распознан. Будут показаны лучшие публикации. Возможные варианты фильтра: Top - Лучшие, Download - Топ-загрузок, Sale - Топ-продаж, Comment - Топ-комментариев, Show - Топ-просмотров, """" - Последние");
			Адрес = Адрес + "property_rating";
		КонецЕсли;
	КонецЕсли;
