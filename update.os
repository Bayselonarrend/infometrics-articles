...
Процедура ОсновнаяОбработка()
	...
	Шаблон           = МассивАргументов[3];
	СобратьЛучшие    = МассивАргументов[4];

	СобратьЛучшие = Истина;
	...
	Если СобратьЛучшие Тогда
		...
		HTML = Лев(HTML , СтрНайти(HTML, "div <class=""clearfix pagination-wrap"">"));
	Иначе
